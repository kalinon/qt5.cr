...
namespace QtAdditions
{
   ...
   QWidgetListWidget::QWidgetListWidget(QWidget* parent): QWidgetListWidget({}, true, QBoxLayout::Direction::TopToBottom, parent) {
   }
   ...
   QWidgetListItem* QWidgetListWidget::getItem(int index)
   {
      if (auto w = dynamic_cast<QWidgetListItem*>(_layout->itemAt(index)->widget()))
            return w;
